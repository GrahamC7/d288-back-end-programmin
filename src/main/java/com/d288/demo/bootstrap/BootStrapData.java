...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (customerRepository.count() == 1) {
            ...
            Customer customer3 = new Customer("Edna", "Mae", "4829 VeryFarAway Ave", "92380", "(994) 739-9374", divisionRepository.findById(33L).get());
            Customer customer4 = new Customer("Samuel", "Tee", "80 WhereEvenIsThat Rd", "27291", "(759) 489-2901", divisionRepository.findById(34L).get());
            Customer customer5 = new Customer("Savannah", "Pompson", "903 Geewiz Way", "45778", "(356) 432-7789", divisionRepository.findById(35L).get());
